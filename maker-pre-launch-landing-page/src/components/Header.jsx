export default  function Header(){
    return(
        <header className="w-screen md:h-145 lg:h-screen space-y-16  text-center grid place-items-center pt-8 md:relative">
            <img className="md:absolute md:top-16 md:left-8 lg:left-42" src="src/assets/logo.svg" alt="logo" />
            <div className="w-screen md:absolute z-20 md:top-32 md:mt-10">
                <img className="sm:hidden" src="src/assets/illustration-hero-mobile.png" alt="illustration-hero-mobile" />
                <div className="md:h-145 justify-between hidden md:flex bg-[url(src/assets/bg-hero-squiggle.svg)] bg-position-[center_0px] bg-size-[600px] bg-no-repeat">
                    <img className="absolute -left-64 lg:-left-10" src="src/assets/illustration-hero-left.svg" alt="illustration-hero-left" />
                    <img className="absolute -right-64 lg:-right-10" src="src/assets/illustration-hero-right.svg" alt="illustration-hero-right" />
                </div>
            </div>
            <section className="grid place-items-center space-y-7 px-4 md:z-50 md:mt-30 lg:mt-0">
                ...
                <img className="animate-bounce" src="src/assets/icon-scroll.svg" alt="icon-scroll" />
            </section>
        </header>
    )
}