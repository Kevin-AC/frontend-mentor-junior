export default function PlanPro() {
    return (
        <article className="bg-Cyan  w-full md:w-111.25 h-111.25 space-y-6 rounded-lg px-5 md:px-8 pt-16 pb-8 relative">
            <img className="absolute -mt-24" src="/icon-paid.svg" alt="icon-free" />
            ...
            <h2 className="Text-Preset-2 text-Neutral-900 flex items-center">$25.00<span className="Text-Preset-5 text-Neutral-900 opacity-60">/mont</span></h2>
            <ul className="text-Neutral-900 Text-Preset-5 space-y-3">
                <li className="flex items-center ">
                    <svg className="fill-current w-3 h-3 mr-2" viewBox="0 0 12 9">
