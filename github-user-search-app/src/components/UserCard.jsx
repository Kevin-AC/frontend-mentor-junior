...
export default function UserCard({user}){
    ...
    if (!user) {
        return(
            <div className="w-full max-w-182.5  h-155 py-8 px-6 dark:bg-Neutral-800 bg-Neutral-0 rounded-2xl text-center space-y-4 drop-shadow-xl ">
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <a className="linkSection Focus rounded-xl " target="blank" href={user.website}>
                                    <svg className="w-10 dark:text-Neutral-0 text-Neutral-900" fill="currentColor" viewBox="0 0 24 24">
