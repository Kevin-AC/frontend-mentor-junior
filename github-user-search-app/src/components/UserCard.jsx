            ...
            <section className="text-[15px]  ">
                <ul className="space-y-2">
                    <li className="linkSection">
                        ...
                        <span className="text-Neutral-0">{user.location}</span>
                    </li>
                    <li>
                        <a className="linkSection" href="">
                            ...
                            <span className="text-Neutral-0 break-all">{user.website}</span>
                        </a>
                ...
                <ul className="space-y-2 ">
                    <li>
                        <a className="opacity-75 linkSection" href="">
                            <span className="order-1 text-Neutral-0 opacity-70">{user.twitter}</span>
                            <svg className="w-5 h-5 text-Neutral-0 opacity-70" fill="currentColor" viewBox="0 0 20 18">
                    ...
                    <li className="linkSection  " >
                        ...
                        <span className="text-Neutral-0">{user.company}</span>
                    </li>
                </ul>
