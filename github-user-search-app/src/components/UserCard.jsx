export default function UserCard(){
    return(
        <article className="w-full h-155 py-8 px-6 bg-Neutral-800 rounded-2xl space-y-8">
            ...
            <section className="text-[15px] space-y-4">
                <ul className="space-y-3">
                    <li className="linkSection">
                        ...
                        <span className="text-Neutral-0">san francisco</span>
                    </li>
                    <li>
                        <a className="linkSection" href="">
                            ...
                            <span className="text-Neutral-0 break-all">https://github.blog</span>
                        </a>
                ...
                <ul className="space-y-3">
                    <li>
                        <a className="opacity-75 linkSection" href="">
                            <span className="order-1 text-Neutral-0 opacity-70">Not Available</span>
                    ...
                    <li className="linkSection">
                        ...
                        <span className="text-Neutral-0">@github</span>
                    </li>
                </ul>
