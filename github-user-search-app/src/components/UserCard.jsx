...
export default function UserCard({user}){
    ...
    if (!user) {
        return(
            <div className="w-full max-w-182.5  h-155 py-8 px-6 dark:bg-Neutral-800 bg-Neutral-0 rounded-2xl text-center space-y-4 ">
    ...
    return(
        <article className="w-full max-w-182.5 h-auto py-8 px-6 sm:p-12 dark:bg-Neutral-800 bg-Neutral-0 rounded-2xl space-y-8 ">
                ...
                <div>
                    ...
                    <section className="mt-6 grid gap-4 sm:grid-cols-2 text-[15px]">
                        <ul className="space-y-2">
                            ...
                            <li>
                                <a className="linkSection " target="blank" href={user.website}>
